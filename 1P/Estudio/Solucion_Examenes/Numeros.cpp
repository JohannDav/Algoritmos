...
// ================= Impresion de areas circulos =================

int areasCirculos() {
	areaCirculo = 0;
	aux2 = 0;
    for (i = 0; i < n; i++) {
    	areaCirculo = arreglo[i] * arreglo[i] * 3.1416;
    	cout << "\nEl radio es: " << arreglo[i] << " y su area es " << areaCirculo;
    	
    	//Sumatoria de areas
    	aux2 = aux2 + areaCirculo;
    	
    }
    cout << "\nLa sumatoria de las areas es: " << aux2;
...
int sumatoria() {
	...
	cout << "\nLa sumatoria de los numeros del arreglo da un total de: " << aux2;
	
	return (0);
}

// ================= Identifica positivos y los contea =================
//numerosNegativos();
int numerosPositivos(){
	...
	for (i = 0; i < n; i++) {
    	if(arreglo[i] > 0 ){
    		cantidad = cantidad + 1;		//Contedo de los positivos
    		cout << "\nNumeros positivos: " << arreglo[i];
    		cout << "\nTotal de numeros positivos: " <<  cantidad;
...
// ================= Identifica negativos y los contea =================
//numerosNegativos();
int numerosNegativos(){
	...
	for (i = 0; i < n; i++) {
    	if(arreglo[i] < 0 ){
    		cantidad = cantidad + 1;		//Contedo de los positivos
    		cout << "\nNumeros negativos: " << arreglo[i];
    		cout << "\nTotal de numeros negativos: " <<  cantidad;
...
int menu() {
    ...
    cout << "\n6 - Suma de areas de circulos";
    cout << "\n7 - Identificacion positivos y negativos";
    cout << "\n8 - Guardar archivo";
    cout << "\n9 - Salir del menu";
