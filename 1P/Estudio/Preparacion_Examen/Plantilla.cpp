...
// ok --1 - Declarar a las variables de forma global (todas las funciones tienen acceso a ellas)
// ok --2 - Declarar funciones de solicitud de datos (numeros, caracteres, string)
// ok --3 - Declarar funciones de impresión de datos (numeros, caracteres, string)
// ok --4 - Declarar funciones de manejo de datos (busqueda de numeros o caracteres)
...
// 6 - En el programa que trabaja con caracteres - Ejecutar una función del compilador para identificar si es mayuscula, numero, etcetera.
// 7 - En el programa que trabaja con caracteres ejecutar funciones para identificar si es símbolo, numero, letra
