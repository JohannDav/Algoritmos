...
int main() {
    ...
    for (repeticion = 0; repeticion == 0;) {
        ...
        switch (opcion) {
            ...
            case (6):  // Ordenamiento metodo burbuja
                burbuja();
                break;

            case (7):  // Ordenamiento metodo flotacion
                flotacion();
                break;

            case (8):  // Ordenamiento metodo seleccion
                seleccion();
                break;

            case (9):  // Ordenamiento metodo insercion
                insercion();
                break;

            case (10): // Ordenamiento metodo quick sort
                ordenamientoQuick();
                break;

            case (11): // Ordenamiento metodo Shell
                shell();
                break;

            case (12): // Ordenamiento metodo heapsort
                heapSort();
                break;
...
int menu() {
    ...
    cout << "\n5 - Busqueda binaria";
    cout << "\n6 - Ordenamiento metodo burbuja";
    cout << "\n7 - Ordenamiento metodo flotacion";
    cout << "\n8 - Ordenamiento metodo seleccion";
    cout << "\n9 - Ordenamiento metodo insercion";
