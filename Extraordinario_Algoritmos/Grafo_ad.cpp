...
//               esto es:   A = 1, B = 2, etc.  Y esto complica un poco la compresión del manejo del grafo en el momento de la programación
//
...
//               complica un poco la compresión del manejo del grafo en el momento de la programación
//               y provoca errores porque el total de la ruta no se podria colocar por ejemplo 11
//
//
//       Ejemplo para la comprensión del manejo del grafo
//                   Ini  Fin      A           B          C          D          E     Nodos  Total
//            	    {"A","B",   " "," ",   "5","2",   "6","1",   " "," ",   " "," ",   "2",   "11"},
//
...
//
// OBSERVA:
//             Observa que en la tabla de adyacencias, están ordenadas las rutas o caminos (filas) de menor peso a mayor peso
...
using namespace std;
    ...
    //   - Van a aumentar la calidad de filas de la tabla de adyacencias, verifique que la declaración de la tabla, sea correcta 
	...
	//   - Para ayudar a su proceso de modificación de la tabla, se recomienda copie la linea numero 81 en cada bloque ruta inicio - fin
    //
	...
	//   Ini  Fin      A           B          C          D          E     Tocados Ruta	      
	    {"A","B",   " "," ",   "5","1",   " "," ",   " "," ",   " "," ",   "1",   "5"},
	    {"A","B",   " "," ",   "5","2",   "6","1",   " "," ",   " "," ",   "2",   "11"},
	    {"A","B",   " "," ",   "6","3",   "6","1",   "7","2",   " "," ",   "3",   "19"},	    
	    {"A","B",   " "," ",   "6","4",   "6","1",   "8","3",   "7","2",   "4",   "27"},
		    
	    {"A","C",   " "," ",   " "," ",   "6","1",   " "," ",   " "," ",   "1",   "6"},
	    {"A","C",   " "," ",   "5","1",   "5","2",   " "," ",   " "," ",   "2",   "10"},
	    {"A","C",   " "," ",   "5","1",   "7","3",   "6","2",   " "," ",   "3",   "18"},		    
	...
	//   Ini  Fin      A           B          C          D          E     Nodos  Total	   	    
		...
		{"A","E",   " "," ",   " "," ",   "6","1",   "7","2",   "8","3",   "3",   "21"},
	 	{"A","E",   " "," ",   "5","2",   "6","1",   "6","3",   "8","4",   "4",   "25"},
	 	{"A","E",   " "," ",   "5","1",   "5","2",   "7","3",   "8","4",   "4",   "25"}, 
	...
	//   Ini  Fin      A           B          C          D          E     Nodos  Total	    
	    ...
	    {"B","E",   " "," ",   " "," ",   "5","1",   "7","2",   "8","3",   "3",   "20"},
	    {"B","E",   "5","1",   " "," ",   "6","2",   "7","3",   "8","4",   "4",   "26"},


	//   Ini  Fin      A           B          C          D          E     Nodos  Total	    
	    {"C","A",   "6","1",   " "," ",   " "," ",   " "," ",   " "," ",   "1",   "6"},
	    {"C","A",   "5","2",   "5","1",   " "," ",   " "," ",   " "," ",   "2",   "10"},
	    {"C","A",   "5","3",   "6","2",   " "," ",   "7","1",   " "," ",   "3",   "18"},
	...
	//   Ini  Fin      A           B          C          D          E     Nodos  Total	    
	    ...
	    {"E","A",   "6","3",   " "," ",   "7","2",   "8","1",   " "," ",   "3",   "21"},
	    {"E","A",   "5","4",   "5","3",   "7","2",   "8","1",   " "," ",   "4",   "25"},
	    
	    {"E","B",   " "," ",   "5","2",   "7","1",   " "," ",   " "," ",   "2",   "12"},
	    {"E","B",   " "," ",   "6","2",   " "," ",   "8","1",   " "," ",   "2",   "14"},
	    {"E","B",   "6","2",   "5","3",   "7","1",   " "," ",   " "," ",   "3",   "18"},
	    {"E","B",   " "," ",   "5","3",   "7","2",   "8","1",   " "," ",   "3",   "20"},
	    {"E","B",   " "," ",   "6","3",   "7","1",   "7","2",   " "," ",   "3",   "20"},
	    {"E","B",   "6","3",   "5","4",   "7","2",   "8","1",   " "," ",   "4",   "26"},
...
int main(){
    ...
    for (k = 0; k == 0; ){
		...
		cout<<"\n                 \t \t \t \t \t \tTocados total";		
		for(i=0; i<140; i++) {    //CAMBIAR EL NUMERO DEPENDIENDO DE LAS FILAS QUE TENGA EL PROGRAMA
