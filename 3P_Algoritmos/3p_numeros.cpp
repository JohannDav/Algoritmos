    ...
    for (i = 0; i < n - 1; i++) {
        for (j = i; j < n; j++) {
            if (arreglo[i][0] > arreglo[j][0]) {
                for (k = 0; k < 5; k++) {
                    auxMatriz[0][k] = arreglo[i][k];
                }
                for (k = 0; k < 5; k++) {
                    arreglo[i][k] = arreglo[j][k];
                }
                for (k = 0; k < 5; k++) {
                    arreglo[j][k] = auxMatriz[0][k];
                }
            }
        }
    }
    ...
    for (i = 0; i < n - 1; i++) {
        for (j = 0; j < n - 1; j++) {
            if (arreglo[j][0] > arreglo[j + 1][0]) {
                for (k = 0; k < 5; k++) {
                    auxMatriz[0][k] = arreglo[j][k];
                }
                for (k = 0; k < 5; k++) {
                    arreglo[j][k] = arreglo[j + 1][k];
                }
                for (k = 0; k < 5; k++) {
                    arreglo[j + 1][k] = auxMatriz[0][k];
                }
            }
        }
    }
...
int seleccion() {
    ...
    for (i = 0; i < n - 1; i++) {
        ...
        if (min_idx != i) {
            ...
            for (k = 0; k < 5; k++) {
                arreglo[i][k] = arreglo[min_idx][k];
            }
            for (k = 0; k < 5; k++) {
                arreglo[min_idx][k] = auxMatriz[0][k];
            }
        }
    }
...
int shell() {
    ...
    while (subarreglo > 0) {
        for (i = subarreglo; i < n; i++) {
            ...
            while ((j >= subarreglo) && (arreglo[j - subarreglo][0] > temp)) {
                for (k = 0; k < 5; k++) {
...
void identificar_mayor(float arreglo[][5], int i, int n) {
    ...
    if (masgrande != i) {
        ...
        for (k = 0; k < 5; k++) {
            arreglo[i][k] = arreglo[masgrande][k];
        }
        for (k = 0; k < 5; k++) {
            arreglo[masgrande][k] = auxMatriz[0][k];
        }
...
void heapSort() {
    ...
    for (i = n - 1; i >= 1; i--) {
        ...
        for (k = 0; k < 5; k++) {
            arreglo[i][k] = arreglo[0][k];
        }
        for (k = 0; k < 5; k++) {
            arreglo[0][k] = auxMatriz[0][k];
        }
...
void quickSort(float arreglo[][5], int limite_izq, int limite_der) {
    ...
    do {
        ...
        if (izq <= der) {
            for (k = 0; k < 5; k++) {
                auxMatriz[0][k] = arreglo[izq][k];
            }
            for (k = 0; k < 5; k++) {
                arreglo[izq][k] = arreglo[der][k];
            }
            for (k = 0; k < 5; k++) {
                arreglo[der][k] = auxMatriz[0][k];
            }
            izq++;
            der--;
        }
